...
def validate_pipeline_imports():
    ...
    try:
        from corpus_io import get_corpus_stats, load_corpus, read_text
        print("  ✅ corpus_io")
        ...
        from stats import analyze_zipf_law, calculate_frequencies
        print("  ✅ stats")

        from viz import create_wordcloud, create_zipf_panels
        print("  ✅ viz")
